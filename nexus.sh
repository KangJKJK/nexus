...
# 3. nexus_s3.sh 수정
sed -i '/start/s|\("[^"]*/nexus-network"\)|/opt/glibc-2.39/lib/ld-2.39.so --library-path /opt/glibc-2.39/lib \1|g' nexus_s3.sh
sed -i '/\$cmd/s|\("[^"]*/nexus-network"\)|/opt/glibc-2.39/lib/ld-2.39.so --library-path /opt/glibc-2.39/lib \1|g' nexus_s3.sh
